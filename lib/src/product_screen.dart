...
class _ProductScreenState extends State<ProductScreen> {
  ...
  void initState() {
    ...
    super.initState();
    _nameController = new TextEditingController(text: widget.idProduct);
    _codebarController = new TextEditingController(text: widget.idProduct);
    _descriptionController = new TextEditingController(text: widget.idProduct);
    _priceController = new TextEditingController(text: widget.idProduct);
    _stockController = new TextEditingController(text: widget.idProduct);
    productImage = 'https://png.pngitem.com/pimgs/s/325-3256246_fa-fa-product-icon-transparent-cartoons-fa-fa.png';
    print(productImage);
  }
                ...
                FlatButton(
                    onPressed: () {
                      ...
                      if (widget.idProduct != null) {
                        ...
                        productReference.child(widget.idProduct).set({
